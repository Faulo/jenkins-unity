...
def call(Map args) {
    ...
    def createBuild = [args.BUILD_FOR_WINDOWS, args.BUILD_FOR_LINUX, args.BUILD_FOR_MAC, args.BUILD_FOR_WEBGL, args.BUILD_FOR_ANDROID].contains('1')

    def deployAny = args.DEPLOYMENT_BRANCHES.contains(env.BRANCH_NAME)

    def reportAny = [args.REPORT_TO_DISCORD, args.REPORT_TO_OFFICE_365, args.REPORT_TO_ADAPTIVE_CARDS,].contains('1')
